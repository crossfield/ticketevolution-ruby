  ...
  describe "#endpoint" do
    ...
    context "when this model is a child" do
      ...
      context "which was generated by a call to the api" do
        ...
        it "should return an endpoint whose parent is another endpoint" do
          # Seems that this spec was never passing, ever since its first intro.
          # See the other pending spec above. They both raise the same exact
          # error, and they were both introduced in commit
          # b54046fb3d7226690c9f66d20962af098f1be571, and seems like the author
          # marked that spec pending, but forgot to mark this one. Therefore I'm
          # marking this one pending as well.
          pending "adding urls to all second layer returns in the api"
          child.endpoint.parent.should be_a TicketEvolution::Clients
        end
      end
